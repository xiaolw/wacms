...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">单曲播放量
        <div class="pull-right" style="width:280px; margin-top:5px;">
    	 ...
    	 <div class="pull-right" style="width:240px; margin-top:5px; margin-right:16px">
         	<div class="input-prepend input-group">
                <span class="add-on input-group-addon">
                    <i class="glyphicon glyphicon-calendar fa fa-music">
                    </i>
                </span>
                <input type="text" class="form-control" value="" placeholder="请输入歌曲名">                                     
            </div>
       </div>
      </h1>
  </div>
...
<div class="row">
  <div class="col-lg-12">
  	<p style="font-size:12px; color:#999">歌曲<strong style="color:#000;">《我的名字叫做安》</strong> 自 <strong style="color:#000;">2014-03-19</strong> 至 <strong style="color:#000">2015-02-07</strong> 播放量统计数据</p>
