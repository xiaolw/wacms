...
<html lang="en">
	...
	<head>
		...
		<!-- Bootstrap Core CSS -->
		<link href="/music_cms/wacms/Public/css/bootstrap.min.css" rel="stylesheet">

		<!-- Custom CSS -->
		<link href="/music_cms/wacms/Public/css/sb-admin.css" rel="stylesheet">

		<!-- Custom Fonts -->
		<link href="/music_cms/wacms/Public/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<![endif]-->
		...
		<!-- jQuery -->
		<script src="/music_cms/wacms/Public/js/jquery.js"></script>

		<!-- Bootstrap Core JavaScript -->
		<script src="/music_cms/wacms/Public/js/bootstrap.js"></script>

		<!-- common JavaScript -->
		<script src="/music_cms/wacms/Public/js/common.js"></script>
	</head>
