...
function(t) {
    ...
    function u(a) {
        ...
        b;
        if ("td" == a.getName() && (b = a.getChild(0).getHtml())) j = a,
    ...
    function v(a) { ! a.name && (a = new CKEDITOR.event(a));
        var b = !/mouse/.test(a.name),
        c = a.data.getTarget(),
        e;
        if ("td" == c.getName() && (e = c.getChild(0).getHtml())) q(a),
        b ? g = c: w = c,
    ...
    function z(a) {
        ...
        switch (e) {
        case 38:
            if (a = c.getParent().getPrevious()) a = a.getChild([c.getIndex()]),
            a.focus();
            b.preventDefault();
            break;
        case 40:
        ...
        case 13:
            ...
            b.preventDefault();
            break;
        case d ? 37 : 39 : if (a = c.getNext()) 1 == a.type && (a.focus(), b.preventDefault(!0));
            else if (a = c.getParent().getNext()) if ((a = a.getChild([0])) && 1 == a.type) a.focus(),
            b.preventDefault(!0);
            break;
        case d ? 39 : 37 : if (a = c.getPrevious()) a.focus(),
            b.preventDefault(!0);
            else if (a = c.getParent().getPrevious()) a = a.getLast(),
            a.focus(),
            b.preventDefault(!0)
        }
    }
        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                    ...
                    focus: function() { (g || this.getElement().getElementsByTag("td").getItem(0)).focus()
                    }
                },
                x, {
                    type: "vbox",
